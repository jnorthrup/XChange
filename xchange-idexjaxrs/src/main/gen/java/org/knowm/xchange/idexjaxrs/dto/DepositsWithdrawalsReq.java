...
public class DepositsWithdrawalsReq   {
  ...
  @ApiModelProperty(value = "(address string) - Address to query deposit/withdrawal history for")
  ...
  @ApiModelProperty(value = "(number) - Inclusive starting UNIX timestamp of returned results, defaults to 0")
  @JsonProperty("start")
  ...
  @ApiModelProperty(value = "(number) - Inclusive ending UNIX timestamp of returned results, defaults to current timestamp")
  @JsonProperty("end")
