...
class IdexjaxrsExchange : Exchange, BaseExchange() {
    ...
    override fun getDefaultExchangeSpecification() = ExchangeSpecification(IdexjaxrsExchange::class.java).apply {
        exchangeDescription = "Idex.market exchange Kotlin based API client "
        exchangeName = "idexjaxrs"
    }
