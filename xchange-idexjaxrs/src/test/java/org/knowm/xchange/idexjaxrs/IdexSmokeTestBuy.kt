...
import org.knowm.xchange.idexjaxrs.IdexjaxrsExchange.Companion.gson
...
fun main(args: Array<String>) {
    ...
    val idex: Exchange = ExchangeFactory.INSTANCE.createExchange(IdexjaxrsExchange::class.java, apiKey,
